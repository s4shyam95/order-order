        ...
        if(data.type == 'play'){
           ...
           if(data.success){
               ...
               if('partner1' in data){
                   ...
                   $('#label-'+data.partner1).css('color', 'red')
               }
               if('partner2' in data){
				   $("#points_table tbody tr td").filter(function () {
						var text = $(this).html();
                   ...
                   $('#label-'+data.partner2).css('color', 'red')
               }
               ...
               if(data.clear_cards){
                   ...
                   for(var i = 0; i < data.partner_players.length; i++){
                       var partner_name = data.partner_players[i];
                       $('#label-'+partner_name).css('color', 'red');
                       $("#points_table tbody tr td").filter(function () {
                            var text = $(this).html();
                            return text == partner_name;
                       }).css('color', 'red');
                   }
               }
               ...
               // Update winner_so_far to have border
               $('.winner_so_far').first().removeClass('winner_so_far');
               $('#label-'+data['winner_so_far']).addClass('winner_so_far');
