        ...
        if data['type'] == 'play':
            ...
            if valid_to_play:
                ...
                if hand.entries.count() == 1:
                    ...
                    partner_players = [game.bid_winner.handle]
                    if game.partner1:
                        partner_players.append(game.partner1.handle)
                    if game.partner2:
                        partner_players.append(game.partner2.handle)
                    play['partner_players'] = partner_players
                play['success'] = True
                play['winner_so_far'] = hand.compute_winner()[0].handle
